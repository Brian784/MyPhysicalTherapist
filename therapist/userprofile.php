...
$sql= "SELECT `First_Name`, `Last_Name`, `License_Id`, `License_Type`, `Profile_Picture`, `Contact_Number` FROM `therapist_account` WHERE Therapist_ID = $UserID";
...
$sqlSched = "SELECT `Working_Day`, `Hospital_Name`, `Start_Time`, `End_Time` FROM `therapist_schedule` WHERE Therapist_ID = $UserID";
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body" style = "width: 100%">
                                    <div class="col-md-4 col-xs-12 col-sm-6 col-lg-4">
                                        <img class="fa-tumblr-square d-flex" width="80%" alt="User Pic" src="<?php echo'therapistprofilepictures/'.$userPicture; ?>"
